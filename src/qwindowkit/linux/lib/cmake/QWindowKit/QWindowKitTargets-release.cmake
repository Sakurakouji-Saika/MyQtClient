...
set_target_properties(QWindowKit::Core PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libQWKCore.so"
  IMPORTED_SONAME_RELEASE "libQWKCore.so"
  )
...
set_target_properties(QWindowKit::Widgets PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libQWKWidgets.so"
  IMPORTED_SONAME_RELEASE "libQWKWidgets.so"
  )
